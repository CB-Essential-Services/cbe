                          ...
                          {(root_page_path !== current_page_path) && <React.Fragment>
                            {has_children && 
                              <ul className="docs-section-items">
                                ...
                                <li key={child_page_idx} className="docs-section-item"><Link to={withPrefix(_.get(child_page, 'url'))} className="docs-item-link">{_.get(child_page, 'frontmatter.title')}<span className="icon-angle-right" aria-hidden="true" /></Link></li>
                                ))}
                              </ul>
                            }
                          </React.Fragment>}
